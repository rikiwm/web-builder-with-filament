                        ...
                        <x-slot name="content">
                            <div class="py-0 md:py-4 w-full max-w-screen-2xl mx-auto">
                                <div class="flex flex-col justify-center items-center border bg-zinc-100/90 dark:bg-zinc-800/80 w-full h-52 lg:h-64 border-gray-200/20 dark:border-zinc-900 rounded-[14px] p-0 md:p-2  px-4 ">
                                    <div class="">
                                        <h1
                                            class="mb-2 text-3xl font-extrabold text-black dark:text-white md:text-2xl lg:text-5xl text-center line-clamp-1">
                                            <span
                                  ...
                                  <div class="-mt-12 -ml-12 p-12 lg:sticky lg:top-4 lg:col-start-3 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
                                        <x-tabs.tabs-button class="lg:sticky lg:top-4lg:overflow-hidden">
                                            ...
                                            <x-slot name="content">
                                                ...
                                                <div class="mb-2 w-full max-w-2xl border-outline bg-white p-2 text-left dark:border-zinc-500/30 dark:bg-zinc-800/10 dark:hover:border-sky-300/50 rounded-lg border" >
                                                    <div class="flex items-start gap-2 text-on-surface-strong dark:text-on-surface-dark-strong">
                                                        ...
                                                        <span class="text-xs font-bold">{{ $item->title }}
                                                            <p class="text-xs font-extralight hover:underline focus:underline focus:outline-hidden text-zinc-500/50 dark:text-zinc-200">{{ $item->created_at->locale('id')->diffForHumans() }}</p>
                                                            <br>
