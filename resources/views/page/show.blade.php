        ...
        justify-center selection:bg-[#03A56A] selection:text-white">
            <div class=" w-full px-6 ">
                <main class="py-12">
                    <div class="py-0 md:py-4 w-full max-w-screen-2xl mx-auto">
                        ...
                        <div class="flex justify-center items-center bg-white w-4/5 lg:w-3/4 h-22 lg:h-28 mx-auto border-b-teal-200/30 border-gray-200/20 dark:border-zinc-950 dark:bg-black rounded-[14px] p-0 md:p-2 mb-2 px-4 -mt-12 md:-mt-20 shadow-sm">
                            <div class="py-4 flex justify-between">
                                <div class="flex justify-start lg:justify-center items-center gap-6 block flex-wrap">
                                    <img src="https://diskominfo.majalengkakab.go.id/wp-content/uploads/2017/05/cropped-logo-diskominfo.png" class="size-6 lg:size-10  rounded-full object-cover" alt="avatar"/>
                                    <div class="flex flex-col gap-1">
                                        <h3 class="font-bold leading-4 text-on-surface-strong dark:text-on-surface-dark-strong">Author:</h3>
                                        <span class="text-xs">Diskominfo Kota Padang</span>
                                    </div>
                                    <div class="flex flex-col gap-1">
                                        <h3 class="font-bold leading-4 text-on-surface-strong dark:text-on-surface-dark-strong">Peliput:
                                            </h3>
                                        <span class="text-xs"> IKP - Diskominfo</span>
                                    </div>
                                    <div class="flex lg:flex-col gap-1 pr-4">
                    ...
                    <div class="relative isolate overflow-hidden bg-white px-6 py-6 sm:py-6 lg:overflow-visible lg:px-0">
                                ...
                                <x-page.article>
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <div class="sm:flex sm:items-center lg:justify-end gap-6  mt-6">
                                            <span class="self-center text-md mb-4 lg:mb-0 font-semibold whitespace-nowrap dark:text-green-200">Share</span>
