@props(['title' => '', 'data' => '','slug' => $data->slug ?? null ])
<div>
    <x-page.section-page>
        <x-slot name="content">
            ...
            <div class="mx-auto w-full lg:max-w-screen-xl ">
                ...
                <div x-data="{ selectedTab: '0' }" class="grid grid-cols-3">                    <!-- Tab List -->
                ...
                @elseif ($slug === 'faq')
                    ...
                    <span     class="text-transparent bg-clip-text bg-gradient-to-r to-zinc-500 from-sky-900">
                        Pertanyaan sering di ajukan</span>
                    </h1>
                ...
                <div class="grid gap-6 lg:grid-cols-1  lg:gap-8">
                            ...
                            <div class="col-span-3 lg:col-span-1 rounded-lg">
                                <div class="pt-3 sm:pt-5 lg:pt-0 ">
                                    <h1 class="text-xl md:text-5xl font-semibold text-black dark:text-white">
                                        {{ $data['content'][0]['data']['title'] ?? 'Lorem ipsum dolor' }}</span> </h1>
                    ...
                    <div class="mt-4">
                        ...
                        <p
                            class="mb-0 text-sm font-extrabold text-zinc-950 dark:text-white md:text-lg lg:text-lg text-center">
