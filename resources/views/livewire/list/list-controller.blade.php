@props(['title' => '', 'data' => '', 'model_view' => ''])
<div>
    <x-page.section-page>
        <x-slot name="content">
            <div class="py-0 md:py-1 max-w-screen-xl  mx-auto ">
                <div
                    class=" p-0 md:p-2 mb-8  mx-auto">

                    <aside aria-label="Related articles" class="px-4 py-8 lg:py-2 lg:px-12 bg-zinc-50/50 dark:backdrop-blur-md dark:bg-transparent ">
