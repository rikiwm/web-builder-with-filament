@props(['title' => '', 'data' => '', 'model_view' => '','column'=>'lg:grid-cols-4 '])
@php
...
<div>
    <x-page.section-page>
        <x-slot name="content">
            <div class="mb-4 lg:mt-4 flex justify-center items-center border bg-zinc-200/90 dark:bg-zinc-800/80 w-full h-52 lg:h-64 border-gray-200/20 dark:border-zinc-900 rounded-[14px] p-0 md:p-2  px-4">
                <div class="items-center text-center">
                    <h1 class="mb-2 text-3xl font-semibold text-gray-50 dark:text-zinc-950 md:text-2xl lg:text-5xl text-center uppercase">
                            {{ $title ?? '-' }}
                    </h1>
                </div>
            </div>
                                ...
                                <div class="grid {{ $column }} gap-6 lg:py-4 py-4">
                                    ...
                                    <div class="w-full min-w-screen">
                                        ...
                                        {{-- <dd class="mt-2 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                            <ul role="list" class="divide-y divide-gray-100 dark:divide-zinc-800 rounded-md border border-gray-200 dark:border-zinc-900">
